...
public:
  ...
  [[nodiscard]] auto HasFinishedTransformBuffer() const noexcept -> bool;
...
inline auto ZoomFilterBufferStriper::HasFinishedTransformBuffer() const noexcept -> bool
{
  return UpdateStatus::AT_END == m_updateStatus;
}
